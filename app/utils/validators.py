...
def validate_integer(
    ...
    Args:
        arg_name (str): the name of the argument (used in default error
            messages)
        ...
        custom_min_message (str): optional, custom message when the value is
            less than minimum
        custom_max_message (str): optional, custom message when the value is
    ...
    if max_value is not None and arg_value > max_value:
        ...
        raise ValueError(f'{arg_name} can not be greater than {max_value}!')
